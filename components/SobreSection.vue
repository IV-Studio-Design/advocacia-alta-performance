<template>
    <section class="w-full flex justify-center items-center pt-16 pb-24 bg-[url('@/assets/images/woman_bg_2.png')] bg-black bg-no-repeat bg-[center_-2.5rem]">
        <div class="-translate-x-36 translate-y-5 w-full max-w-[27.5rem] flex gap-5 flex-col justify-start items-start border border-lightPeach/30 backdrop-blur-sm bg-black/50 pl-10 pt-12 pb-16 rounded-3xl">
            ...
            <p class="font-poppins font-light text-[13px] leading-4 text-snowWhite">
                <i>
                    ...
                    de escritórios de alto padrão, Dra. Carolina Mendes <br>
                    é especialista em estrátegias que transformam <br>
                    advogados em líderes de suas áreas.
                </i>
            </p>
            ...
            <p class="font-poppins font-light text-[13px] leading-4 text-snowWhite">
                <i>
                    ...
                    patamares de faturamento e reconhecimento. <br>
                    Com uma abordagem prática e direcionada, já <br>
                    ajudou dezenas de profissionais a construir <br>
                    escritórios mais lucrativos, estruturados e com <br>
            ...
            <p class="font-poppins text-sm leading-4 font-semibold text-lightPeach my-3">
                <i>
                    ...
                    estrátegico, eficiente e altamente reconhecido <br>
                    no mercado."
                </i>
            </p>
